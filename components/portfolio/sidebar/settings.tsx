...
export default function Settings() {
  ...
  return (
    <aside className="h-full overflow-y-auto flex w-full flex-col z-40 bg-popover">
      <div className="px-2 py-2 text-[11px] font-bold text-muted-foreground uppercase tracking-wider">
        Settings
      </div>

      <div className="pb-2 flex flex-col gap-3">
        <div className="p-2 rounded-md flex items-center justify-between gap-2">
